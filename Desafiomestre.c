...
int main(){
    ...
    carta1.superpoder1 = (float)carta1.populacao + (float)carta1.area + (float)carta1.pib + (float)carta1.pontos + carta1.pibcapita + (1.0 / carta1.densidade);
    ...
    carta2.superpoder2 = (float)carta2.populacao + (float)carta2.area + (float)carta2.pib + (float)carta2.pontos + carta2.pibcapita + (1.0 / carta2.densidade);
    ...
    printf("PIB per Capita: Carta 1 venceu (%d)\n", carta1.pibcapita > carta2.pibcapita);
